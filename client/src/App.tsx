...
import { LogOut, Crown, Settings, Users, Package, TrendingUp, CreditCard, BarChart3 } from 'lucide-react';

function Dashboard() {
  const { user, userSubscription, logout } = useAuth();
  const { checkLimit, limitModal, closeLimitModal } = useFeatureLimits();
